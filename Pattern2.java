...
public class Pattern2 extends JFrame implements ActionListener{
	...
	patterns.addActionListener(this);
		...
		btn6=new JButton(icon7);
		btn6.setBounds(400,250,100,100);
		btn6.addActionListener(this);
		
		
		btn7=new JButton(icon1);
	...
	{
		JOptionPane.showMessageDialog(Pattern2.this,"Complete!!!");
	}
