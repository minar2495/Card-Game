...
public class Pattern8 extends JFrame implements ActionListener{
	...
	patterns.addActionListener(this);
		...
		btn6=new JButton(icon4);
		btn6.setBounds(400,250,100,100);
		btn6.addActionListener(this);
		
		
		btn7=new JButton(icon9);
	...
	{
		JOptionPane.showMessageDialog(Pattern8.this,"Complete!!!");
	}
