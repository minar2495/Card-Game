...
public class Pattern7 extends JFrame implements ActionListener{
	...
	patterns.addActionListener(this);
		...
		btn7=new JButton(icon8);
		btn7.setBounds(100,400,100,100);
		btn7.addActionListener(this);
		
		
		btn8=new JButton(icon2);
	...
	{
		JOptionPane.showMessageDialog(Pattern7.this,"Complete!!!");
	}
